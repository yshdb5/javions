...
public class CprDecoder
{
    ...
    public static GeoPos decodePosition(double x0, double y0, double x1, double y1, int mostRecent)
    {
        ...
        int latitude0_T32, latitude1_T32, longitude0_T32, longitude1_T32, zonePhi, zonePhi0, zonePhi1, zoneLambda, zoneLambda0, zoneLambda1,  nombreZones00, nombreZones01, nombreZones1;
